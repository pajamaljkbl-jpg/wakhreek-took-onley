...
async function sendNativePushToUser(userId, payload) {
  ...
  if (!userId || !projectId || !supabaseAdmin) return { sent: 0, skipped: true };
...
export async function sendPushToUser(userId, payload) {
  ...
  return { sent: webSent + Number(nativeResult.sent || 0), webSent, nativeSent: Number(nativeResult.sent || 0) };
}
